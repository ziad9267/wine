...
static const WCHAR *hack_append_command_line( const WCHAR *cmd )
{
    ...
    options[] =
    {
        ...
        {L"UplayWebCore.exe", L" --use-angle=vulkan  --no-sandbox"},
        {L"Paradox Launcher.exe", L" --use-angle=gl  --no-sandbox"},
        {L"Launcher.exe", L" --no-sandbox"},
        {L"Montaro\\nw.exe", L" --use-gl=swiftshader"},
        {L"Aisling and the Tavern of Elves\\nw.exe", L" --use-gl=swiftshader"},
        {L"Snares of Ruin 2\\SoR2.exe", L" --use-gl=swiftshader"},
        {L"\\EOSOverlayRenderer-Win64-Shipping.exe", L" --use-gl=swiftshader --in-process-gpu --no-sandbox"},
        {L"\\EpicOnlineServicesUIHelper", L" --use-angle=vulkan --no-sandbox"},
        ...
        {L"UnrealCEFSubProcess.exe", L" --use-gl=swiftshader --no-sandbox", "2316580"},
        {L"\\EACefSubProcess.exe", L" --use-angle=vulkan  --no-sandbox"},
    };
    unsigned int i;
    char sgi[64];
