...
__ASM_GLOBAL_FUNC( "#KiUserExceptionDispatcher",
                   ...
                   "add x0, sp, #0x390\n\t"       /* rec (context + 1) */
                   "mov x1, sp\n\t"               /* context */
                   "bl " __ASM_FUNC_NAME("dispatch_exception_arm64ec") "\n\t"
                   "brk #1" )
...
__ASM_GLOBAL_FUNC( "#KiUserApcDispatcher",
                   ...
                   "ldr w4, [sp, #0x20]\n\t"      /* alertable */
                   "add x5, sp, #0x30\n\t"        /* context */
                   "bl " __ASM_FUNC_NAME("dispatch_apc") "\n\t"
                   "brk #1" )
...
__ASM_GLOBAL_FUNC( "#KiUserCallbackDispatcher",
                   ...
                   "mov x1, #0\n\t"               /* ret_len */
                   "mov x0, x1\n\t"               /* ret_ptr */
                   "bl " __ASM_FUNC_NAME("NtCallbackReturn") "\n\t"
                   "bl " __ASM_FUNC_NAME("RtlRaiseStatus") "\n\t"
                   "brk #1" )
...
__ASM_GLOBAL_FUNC( "#KiUserEmulationDispatcher",
                   ...
                   ".seh_endprologue\n\t"
                   "mov x0, sp\n\t"        /* context */
                   "bl " __ASM_FUNC_NAME("dispatch_emulation") "\n\t"
                   "brk #1" )
...
{
    asm( ".seh_proc " __ASM_FUNC_NAME("RtlCaptureContext") "\n\t"
         ".seh_endprologue\n\t"
         "stp x8, x0,   [x0, #0x78]\n\t"    /* context->Rax,Rcx */
         "stp x1, x27,  [x0, #0x88]\n\t"    /* context->Rdx,Rbx */
         "mov x1, sp\n\t"
         ...
         "mrs x2, fpcr\n\t"
         "mrs x3, fpsr\n\t"
         "b " __ASM_FUNC_NAME("capture_context") "\n\t"
         ".seh_endproc" );
}
...
{
    asm( ".seh_proc " __ASM_FUNC_NAME("NTDLL__setjmpex") "\n\t"
         ".seh_endprologue\n\t"
         "stp x1, x27,  [x0]\n\t"          /* jmp_buf->Frame,Rbx */
         "mov x1, sp\n\t"
         "stp x1, x29,  [x0, #0x10]\n\t"   /* jmp_buf->Rsp,Rbp */
...
{
    asm( ".seh_proc " __ASM_FUNC_NAME("RtlRaiseException") "\n\t"
         "sub sp, sp, #0x4d0\n\t"     /* sizeof(context) */
         ".seh_stackalloc 0x4d0\n\t"
         "stp x29, x30, [sp, #-0x20]!\n\t"
         ...
         ".seh_endprologue\n\t"
         "add x0, sp, #0x20\n\t"
         "bl " __ASM_FUNC_NAME("RtlCaptureContext") "\n\t"
         "add x1, sp, #0x20\n\t"       /* context pointer */
         "ldr x0, [sp, #0x10]\n\t"     /* rec */
         "ldr x2, [x1, #0xf8]\n\t"     /* context->Rip */
         ...
         "ldrb w2, [x3, #2]\n\t"       /* peb->BeingDebugged */
         "cbnz w2, 1f\n\t"
         "bl " __ASM_FUNC_NAME("dispatch_exception") "\n"
         "1:\tmov w2, #1\n\t"
         "bl " __ASM_FUNC_NAME("NtRaiseException") "\n\t"
         "b " __ASM_FUNC_NAME("RtlRaiseStatus") "\n\t" /* does not return */
         ".seh_endproc" );
}
...
{
    asm( ".seh_proc " __ASM_FUNC_NAME("RtlUserThreadStart") "\n\t"
         "stp x29, x30, [sp, #-16]!\n\t"
         ".seh_save_fplr_x 16\n\t"
         ".seh_endprologue\n\t"
...
{
    asm( ".seh_proc " __ASM_FUNC_NAME("DbgUiRemoteBreakin") "\n\t"
         "stp x29, x30, [sp, #-16]!\n\t"
         ".seh_save_fplr_x 16\n\t"
         ".seh_endprologue\n\t"
         ...
         "ldrb w0, [x0, 0x02]\n\t"   /* peb->BeingDebugged */
         "cbz w0, 1f\n\t"
         "bl " __ASM_FUNC_NAME("DbgBreakPoint") "\n"
         "1:\tmov w0, #0\n\t"
         "bl " __ASM_FUNC_NAME("RtlExitUserThread") "\n"
...
{
    asm( ".seh_proc " __ASM_FUNC_NAME("DbgBreakPoint") "\n\t"
         ".seh_endprologue\n\t"
         "brk #0xf000\n\t"
         "ret\n\t"
         ".seh_endproc" );
...
{
    asm( ".seh_proc " __ASM_FUNC_NAME("DbgUserBreakPoint") "\n\t"
         ".seh_endprologue\n\t"
         "brk #0xf000\n\t"
         "ret\n\t"
         ".seh_endproc" );
